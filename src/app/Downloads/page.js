...
function Downloads() {
  ...
  return (
    <div className="commonContainer">
      <div className="  ">
        <div className="  h-auto  relative w-full overflow-hidden rounded-b-[40px] md:pb-20 pb-4 md:pt-44 pt-20 md:px-10 px-6   bg-slate-900 flex flex-col items-center justify-center rounded-lg">
          <div className="  absolute inset-0 w-full h-full bg-slate-900 z-20 [mask-image:radial-gradient(transparent,white)] pointer-events-none" />

          <Boxes />
          <div className="flex justify-between lg:flex-row flex-col sm:gap-4 items-center z-20">
